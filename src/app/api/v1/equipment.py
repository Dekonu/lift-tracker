        ...
        try:
            ...
            if existing:
                ...
                try:
                    ...
                    existing_equipment_map[name.lower()] = cast(EquipmentRead, {
                ...
                for wger_equipment in equipment_data.get("results", []):
                    try:
                        ...
                        if existing:
                            ...
                            # Only update if enabled status changed (Wger doesn't have enabled field, so we keep existing)
                            ...
                            try:
                                ...
                                existing_equipment_map[equipment_name.lower()] = cast(EquipmentRead, {
                                    "name": equipment_name,
                                    "enabled": True
                                })
                            except sqlalchemy_exc.IntegrityError:
