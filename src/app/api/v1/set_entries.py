...
async def update_set_entry(
    ...
    **Raises:**
    ...
    entry_id = set_entry.exercise_entry_id if hasattr(set_entry, "exercise_entry_id") else set_entry["exercise_entry_id"]
    ...
    updated = await crud_set_entry.update(db=db, object=update_dict, id=set_id)
    await db.commit()
