...
async def create_exercise_with_muscle_groups(db: AsyncSession, exercise_data: ExerciseCreate) -> ExerciseRead:
    ...
    if exercise is None:
        ...
        exercise_dict = {
            ...
            "enabled": (created_exercise.enabled if hasattr(created_exercise, "enabled") else True),
        }
