...
from sqlalchemy import Enum as SQLEnum, ForeignKey, Float, Integer, String, Text
...
class Set(Base):
    ...
    exercise_instance_id: Mapped[int] = mapped_column(ForeignKey("exercise_instance.id", ondelete="CASCADE"), index=True)
    ...
    # Relationships
    exercise_instance: Mapped["ExerciseInstance"] = relationship("ExerciseInstance", back_populates="sets", init=False)
