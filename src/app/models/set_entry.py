...
class SetEntry(Base):
    """Individual set within an exercise entry."""

    __tablename__ = "set_entry"

    id: Mapped[int] = mapped_column(autoincrement=True, primary_key=True, init=False)
    exercise_entry_id: Mapped[int] = mapped_column(ForeignKey("exercise_entry.id"), nullable=False, index=True)
    ...
    # Relationships
    exercise_entry: Mapped["ExerciseEntry"] = relationship("ExerciseEntry", back_populates="sets", init=False)  # noqa: F821
